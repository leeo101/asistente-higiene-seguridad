                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', minWidth: 0, flex: 1 }}>
                                    ...
                                    <div style={{ minWidth: 0, flex: 1 }}>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.8rem', color: 'var(--color-text-muted)', marginTop: '0.2rem', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                            <Calendar size={14} style={{ flexShrink: 0 }} /> <span style={{ flexShrink: 0 }}>{new Date(item.date || item.createdAt).toLocaleDateString()}</span> - <Building2 size={14} style={{ flexShrink: 0 }} /> <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{item.sector || 'Sin sector'}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
