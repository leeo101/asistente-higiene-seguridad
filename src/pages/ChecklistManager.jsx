...
export default function ChecklistManager() {
    ...
    return (
        <div className="flex bg-[#F4F5F7] min-h-screen text-slate-900 font-sans overflow-x-hidden">
            <div className="no-print">
                <Sidebar />
            </div>

            <main className="flex-1 p-8 ml-64 overflow-y-auto print:ml-0 print:p-0">
                <div className="no-print mb-8 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-4 w-full md:w-auto">
                        <button onClick={() => navigate(-1)} className="p-3 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl transition-colors active:scale-95 border border-slate-200">
                            <ArrowLeft size={24} />
                        </button>
                        <div>
                            ...
                            <p className="text-slate-500 font-medium">Control H&S</p>
                        </div>
                    </div>
