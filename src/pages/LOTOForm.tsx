    ...
    <div className="min-h-[100vh] bg-[var(--color-background)] pb-[8rem] pt-24">
      <ModuleFormLayout className="no-print">
        ...
        <ModuleFormDocument>
                ...
                <div style={{ gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr 1fr' }} className="grid gap-[1.5rem]">
                    ...
                    <div style={isMobile ? {} : { gridColumn: 'span 3' }}>
                        <WorkerMedicalChecker
                          ...
                          riskType="electrical"
                          label="Supervisor / Responsable LOTO *"
            ...
            <ModuleFormSection title="Paso 1: Fuentes de Energía" icon={<span className="text-[1.2rem]">⚡</span>}>
                    ...
                    {ENERGY_TYPES.map((type) => {
                        ...
                        return (
                            <button
                                ...
                                <div style={{ filter: isSelected ? `drop-shadow(0 0 10px ${type.color})` : 'grayscale(100%) opacity(60%)' }} className="text-[2.5rem] transition-[all_0.3s]">
                                    {type.icon}
                                </div>
            ...
            <ModuleFormSection title="Paso 2: Dispositivos de Bloqueo" icon={<span className="text-[1.2rem]">🔒</span>}>
            ...
            <ModuleFormSection title="Instrucciones Paso a Paso / Observaciones" icon={<Pencil size={20} />}>
