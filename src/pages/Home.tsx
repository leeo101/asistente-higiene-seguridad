...
{ to: '/lighting', icon: <Lightbulb weight="duotone" size={26} />, label: 'Iluminación', sub: 'Medición Luxométrica y Deslumbramiento', color: '#eab308', bg: 'rgba(234,179,8,0.1)', premium: true, category: 'specific', norm: 'ISO 8995' },
