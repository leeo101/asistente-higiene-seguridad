        ...
        <div className="mt-[2.5rem] max-w-[1200px] m-[2.5rem_auto_0] p-[0_1rem]">
          ...
          <div className="mb-[4rem]">
            <div className="flex flex-col gap-[1.5rem] mb-[2rem]" style={{ minWidth: 0 }}>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-[1rem] mb-[2rem] relative z-[5] no-print w-[100%] overflow-hidden">
                <div className="flex flex-nowrap gap-[0.6rem] overflow-x-auto pb-[0.3rem] w-[100%] md:flex-[1] hide-scrollbar items-center" style={{ WebkitOverflowScrolling: 'touch' }}>
                  <button
                    onClick={() => setActiveCategory('all')}
                    className={`whitespace-nowrap px-[1.2rem] py-[0.6rem] rounded-[100px] font-[800] text-[0.85rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'all' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>
                    Todos
                  </button>
                  {categories.includes('docs') && <button onClick={() => setActiveCategory('docs')} className={`whitespace-nowrap px-[1.2rem] py-[0.6rem] rounded-[100px] font-[800] text-[0.85rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'docs' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>Documentación</button>}
                  {categories.includes('critical') && <button onClick={() => setActiveCategory('critical')} className={`whitespace-nowrap px-[1.2rem] py-[0.6rem] rounded-[100px] font-[800] text-[0.85rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'critical' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>Riesgo Crítico</button>}
                  {categories.includes('specific') && <button onClick={() => setActiveCategory('specific')} className={`whitespace-nowrap px-[1.2rem] py-[0.6rem] rounded-[100px] font-[800] text-[0.85rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'specific' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>Específicos</button>}
                  {categories.includes('management') && <button onClick={() => setActiveCategory('management')} className={`whitespace-nowrap px-[1.2rem] py-[0.6rem] rounded-[100px] font-[800] text-[0.85rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'management' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>Gestión</button>}
                  {categories.includes('ia') && <button onClick={() => setActiveCategory('ia')} className={`whitespace-nowrap px-[1.2rem] py-[0.6rem] rounded-[100px] font-[800] text-[0.85rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'ia' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>IA</button>}
                </div>

                <button 
                  onClick={handleToggleInspectorMode}
                  className={`flex justify-between items-center gap-[0.8rem] px-[1.2rem] py-[0.65rem] rounded-[100px] font-[800] text-[0.85rem] transition-all flex-shrink-0 cursor-pointer border-[1px] outline-none w-[100%] md:w-auto ${isInspectorMode ? 'bg-[#10b981] text-white border-transparent shadow-[0_4px_15px_rgba(16,185,129,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:translate-y-[-1px] shadow-sm'}`}
                >
                  <span className="flex items-center gap-[0.4rem]">Modo Campo</span>
