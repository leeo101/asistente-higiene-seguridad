...
{ to: '/risk-maps-history', icon: <MapTrifold weight="duotone" size={26} />, label: 'Mapas', sub: 'Croquis de Riesgos', color: '#10b981', bg: 'rgba(16,185,129,0.1)', premium: true, category: 'docs', norm: 'ISO 31000' },
            ...
            <div className="flex flex-col gap-[1.5rem] mb-[2rem]" style={{ minWidth: 0 }}>
              ...
              <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-[1rem] mb-[2rem] relative z-[5] no-print w-[100%] overflow-hidden">
                <div className="flex flex-nowrap gap-[0.8rem] overflow-x-auto pb-[0.5rem] w-[100%] hide-scrollbar items-center" style={{ WebkitOverflowScrolling: 'touch', scrollSnapType: 'x mandatory' }}>
                  ...
                  {categories.includes('docs') && <button onClick={() => setActiveCategory('docs')} style={{ scrollSnapAlign: 'start' }} className={`whitespace-nowrap px-[1.2rem] py-[0.65rem] rounded-[100px] font-[800] text-[0.9rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'docs' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>Documentación</button>}
                  {categories.includes('critical') && <button onClick={() => setActiveCategory('critical')} style={{ scrollSnapAlign: 'start' }} className={`whitespace-nowrap px-[1.2rem] py-[0.65rem] rounded-[100px] font-[800] text-[0.9rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'critical' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>Riesgo Crítico</button>}
                  {categories.includes('specific') && <button onClick={() => setActiveCategory('specific')} style={{ scrollSnapAlign: 'start' }} className={`whitespace-nowrap px-[1.2rem] py-[0.65rem] rounded-[100px] font-[800] text-[0.9rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'specific' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>Específicos</button>}
                  {categories.includes('management') && <button onClick={() => setActiveCategory('management')} style={{ scrollSnapAlign: 'start' }} className={`whitespace-nowrap px-[1.2rem] py-[0.65rem] rounded-[100px] font-[800] text-[0.9rem] transition-all flex-shrink-0 cursor-pointer border-[1px] ${activeCategory === 'management' ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-[0_4px_15px_rgba(59,130,246,0.35)] transform translate-y-[-2px]' : 'bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)] hover:border-[rgba(59,130,246,0.3)] hover:translate-y-[-1px] shadow-sm'}`}>Gestión</button>}
