...
{ to: '/loto', icon: <Lock weight="duotone" size={26} />, label: 'LOTO', sub: 'Bloqueo, Etiquetado y Control de Energía', color: '#dc2626', bg: 'rgba(220,38,38,0.1)', premium: true, category: 'critical', norm: 'OSHA 1910' },
...
{ to: '/noise-assessment', icon: <SpeakerHigh weight="duotone" size={26} />, label: 'Ruido', sub: 'Dosimetría y Mapa de Ruido — ISO 9612', color: '#8b5cf6', bg: 'rgba(139,92,246,0.1)', premium: true, category: 'specific', norm: 'ISO 9612' },
...
{ to: '/chemical-safety', icon: <Flask weight="duotone" size={26} />, label: 'Seguridad Química', sub: 'Fichas SDS/MSDS y Control GHS/SGA', color: '#ec4899', bg: 'rgba(236,72,153,0.1)', premium: true, category: 'specific', norm: 'GHS/SGA' },
...
{ to: '/working-at-height', icon: <HardHat weight="duotone" size={26} />, label: 'Trabajo en Altura', sub: 'Permisos, Arneses y Check Pre-tarea', color: '#3b82f6', bg: 'rgba(59,130,246,0.1)', premium: true, category: 'critical', norm: 'ISO 45001' },
