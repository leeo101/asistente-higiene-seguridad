    ...
    return (
        <div className="container">
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                ...
                <h1 style={{ margin: 0, fontSize: '1.5rem' }}>Mi Firma y Sello</h1>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                <div className="card">
                    ...
                    <div style={{ position: 'relative', border: '2px dashed var(--color-border)', borderRadius: '8px', background: '#f9f9f9', height: '150px' }}>
                        {signatureImage ? (
                ...
                <button onClick={handleSave} className="btn-primary" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem' }}>
