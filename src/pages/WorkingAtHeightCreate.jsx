...
export default function WorkingAtHeightCreate() {
        ...
        <div className="container" style={{ paddingBottom: '6rem', maxWidth: '900px', paddingTop: '2rem' }}>
            ...
            <div className="card" style={{ padding: '2.5rem', paddingTop: '2rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '1.5rem' }}>
                    ...
                    <div><label style={labelStyle}>Altura (metros)</label><input type="number" value={permit.height} onChange={(e) => setPermit({ ...permit, height: e.target.value })} style={inputStyle} /></div>
                    <div style={{ gridColumn: '1 / -1' }}><label style={labelStyle}>Tipo de Trabajo</label><input type="text" value={permit.workType} onChange={(e) => setPermit({ ...permit, workType: e.target.value })} style={inputStyle} /></div>
                </div>
                ...
                <div style={{ marginBottom: '1.5rem' }}><label style={labelStyle}>Observaciones</label><textarea value={permit.observations} onChange={(e) => setPermit({ ...permit, observations: e.target.value })} style={{ ...inputStyle, minHeight: '60px' }} /></div>
