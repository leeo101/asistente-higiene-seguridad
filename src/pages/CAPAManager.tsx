            ...
            <div style={{
                ...
                <div className="flex-[1] min-w-[280px] relative h-[50px]">
                    ...
                    <input
                      ...
                      className="rounded-[var(--radius-lg)] border-[1px_solid_var(--color-input-border)] bg-[var(--color-surface)] text-[var(--color-text)] text-[0.95rem] font-[500] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all" 
                    />
                </div>
