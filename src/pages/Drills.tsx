        ...
        },
        {
            ...
            render: (item: any) => (
                <div style={{ display: 'flex', gap: '0.4rem' }}>
                    ...
                    <button onClick={() => navigate('/drills/new', { state: { editData: item } })} style={{ padding: '0.4rem', background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.2)', borderRadius: '8px', color: '#3b82f6', cursor: 'pointer' }} title="Editar"><PencilSimple size={15} /></button>
