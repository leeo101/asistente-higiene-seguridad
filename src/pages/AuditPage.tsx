    ...
    <div style={{ paddingBottom: isMobile ? '80px' : '2rem' }} className="min-h-[100vh] bg-[var(--color-background)]">
            ...
            {isMobile && (
              <div className="p-[0_1rem_1rem] flex gap-[0.75rem]">
                ...
                <button onClick={() => navigate('/audit/new')} className="w-[auto] m-[0] p-[0_1rem] flex items-center justify-center rounded-[16px] bg-[#22c55e] text-[#fff] border-none cursor-pointer box-shadow-[0_4px_15px_rgba(34,197,94,0.3)]"><Plus size={20} /></button>
              </div>
            )}
