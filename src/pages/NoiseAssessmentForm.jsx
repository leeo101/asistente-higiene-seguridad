                ...
                <div className="card" style={{ padding: '2rem', background: 'var(--gradient-card)', border: '1px solid var(--glass-border)' }}>
                    ...
                    <div style={{ marginTop: '2.5rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : 'repeat(3, 1fr)', gap: '1rem' }}>
                            <LevelInput label="Lavg (Promedio) *" value={measurement.levels.lavg} onChange={(v) => handleLevelChange('lavg', v)} placeholder="85" inputStyle={inputStyle} labelStyle={labelStyle} />
                            <LevelInput label="Lmax" value={measurement.levels.lmax} onChange={(v) => handleLevelChange('lmax', v)} placeholder="95" inputStyle={inputStyle} labelStyle={labelStyle} />
                            <LevelInput label="Lmin" value={measurement.levels.lmin} onChange={(v) => handleLevelChange('lmin', v)} placeholder="70" inputStyle={inputStyle} labelStyle={labelStyle} />
                            <LevelInput label="Lpeak" value={measurement.levels.lpeak} onChange={(v) => handleLevelChange('lpeak', v)} placeholder="130" inputStyle={inputStyle} labelStyle={labelStyle} />
                            <LevelInput label="Lex 8h" value={measurement.levels.lex8h} onChange={(v) => handleLevelChange('lex8h', v)} placeholder="82" inputStyle={inputStyle} labelStyle={labelStyle} />
                        </div>
                    </div>
...
function LevelInput({ label, value, onChange, placeholder, inputStyle, labelStyle }) {
    return (
        <div>
