...
export default function NoiseAssessmentPage() {
    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--color-background)', paddingBottom: isMobile ? '80px' : '2rem' }}>
            ...
            {/* Modal de Agregar - Full Screen en Mobile */}
            {showAddModal && (
                <AddMeasurementModal
...
function AddMeasurementModal({ measurement, setMeasurement, onSave, onClose, isMobile, MEASUREMENT_TYPES, HEARING_PROTECTION }) {
