        ...
        },
        {
            ...
            render: (item: any) => (
                <div style={{ display: 'flex', gap: '0.4rem' }}>
                    ...
                    <button onClick={() => requirePro(() => setShareCard(item))} style={{ padding: '0.4rem', background: 'rgba(22,163,74,0.08)', border: '1px solid rgba(22,163,74,0.2)', borderRadius: '8px', color: '#16a34a', cursor: 'pointer' }} title="Compartir"><ShareNetwork as Share2 size={15} /></button>
