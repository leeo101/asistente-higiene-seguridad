...
export default function ThermalStressPdfGenerator({ report, onBack }) {
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: `Estres_Termico_${report.puesto.replace(/\s+/g, '_')}_${report.fecha}`,
    });
        ...
        <div className="container" style={{ paddingBottom: '3rem', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="no-print" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem', zIndex: 10, flexWrap: 'wrap', gap: '1rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <h1 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 800 }}>Previsualización de Informe</h1>
                </div>
                    ...
                    <div style={{ borderBottom: '3px solid #1e293b', paddingBottom: '1rem', marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <div>
                            ...
                            <div style={{ display: 'flex', gap: '1.5rem', color: '#475569', fontSize: '10pt' }}>
                                <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}><MapPin size={14} /> Ref: {report.sector}</span>
                                <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}><Calendar size={14} /> Fecha de Medición: {new Date(report.fecha + 'T12:00:00Z').toLocaleDateString()}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10pt' }}>
                            <tbody>
                                <tr>
                                    ...
                                    <td style={{ border: '1px solid #cbd5e1', padding: '6px 8px', fontWeight: 'bold' }}>{report.puesto}</td>
                                </tr>
                                <tr>
                    ...
                    <div style={{ marginBottom: '1.5rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '1rem' }}>
                            <div style={{ border: '1px solid #e2e8f0', borderRadius: '6px', padding: '10px', textAlign: 'center' }}>
                                ...
                                <div style={{ fontSize: '14pt', fontWeight: 900, color: '#1e293b', marginTop: '4px' }}>{report.tbh}°C</div>
                            </div>
                            <div style={{ border: '1px solid #e2e8f0', borderRadius: '6px', padding: '10px', textAlign: 'center' }}>
                                <div style={{ fontSize: '8pt', color: '#64748b', fontWeight: 'bold', textTransform: 'uppercase' }}>T° Globo Térmico (Tg)</div>
                                <div style={{ fontSize: '14pt', fontWeight: 900, color: '#1e293b', marginTop: '4px' }}>{report.tg}°C</div>
                            </div>
                            <div style={{ border: '1px solid #e2e8f0', borderRadius: '6px', padding: '10px', textAlign: 'center', opacity: report.cargaSolar ? 1 : 0.3 }}>
                                ...
                                <div style={{ fontSize: '14pt', fontWeight: 900, color: '#1e293b', marginTop: '4px' }}>{report.cargaSolar ? `${report.tbs}°C` : 'N/A'}</div>
                            </div>
                        </div>
