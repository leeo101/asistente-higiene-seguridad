...
export default function WorkingAtHeightPdf({ data }) {
    if (!data) return null;
    ...
    return (
        <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
            ...
            >
                ...
                {/* Signatures */}
                <div style={{ marginTop: 'auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', paddingTop: '1rem' }}>
                    <div style={{ textAlign: 'center' }}>
                        <div style={{ height: '60px', borderBottom: '1px solid #000', marginBottom: '0.3rem' }}></div>
                        <span style={{ fontSize: '0.7rem', fontWeight: 900, display: 'block' }}>FIRMA DEL TRABAJADOR</span>
                    </div>
                    <div style={{ textAlign: 'center' }}>
                        <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid #000', marginBottom: '0.3rem' }}>
                             {data.signature && <img src={data.signature} alt="Firma Profesional" style={{ height: '100%', objectFit: 'contain' }} />}
                        </div>
                        <span style={{ fontSize: '0.7rem', fontWeight: 900, display: 'block' }}>RESPONSABLE DE SEGURIDAD</span>
                    </div>
                </div>
