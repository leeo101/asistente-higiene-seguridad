  ...
  return (
    <div className="stars-container" ref={containerRef}>
            ...
            <div ref={wrap1} style={wrapStyle}>
                ...
                <div className="stars transform-[translateY(-2000px)]" style={{ boxShadow: shadowsSmall }} />
            </div>

            {/* Layer 2 — medium stars */}
            <div ref={wrap2} style={wrapStyle}>
                <div className="stars2" style={{ boxShadow: shadowsMedium }} />
                <div className="stars2 transform-[translateY(-2000px)]" style={{ boxShadow: shadowsMedium }} />
            </div>

            {/* Layer 3 — large/close stars */}
            <div ref={wrap3} style={wrapStyle}>
                <div className="stars3" style={{ boxShadow: shadowsLarge }} />
                <div className="stars3 transform-[translateY(-2000px)]" style={{ boxShadow: shadowsLarge }} />
            </div>

            {/* Glowing orbs */}
            <div style={{ position: 'absolute' as const }} className="inset-[0] bg-[radial-gradient(circle_at_top_right,_rgba(255,255,255,0.05)_0%,_transparent_60%)] pointer-events-[none] z-[1]" />
            <div className="hero-orb-right z-[1] opacity-[0.6]" />
            <div style={{ position: 'absolute' as const }} className="top-[-40px] right-[-40px] w-[180px] h-[180px] rounded-[50%] bg-[rgba(37,99,235,0.1)] pointer-events-[none] z-[1]" />
            <div style={{ position: 'absolute' as const }} className="bottom-[-60px] left-[60px] w-[220px] h-[220px] rounded-[50%] bg-[rgba(37,99,235,0.15)] pointer-events-[none] z-[1]" />
