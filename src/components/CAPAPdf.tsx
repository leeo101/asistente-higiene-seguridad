            ...
            >
                ...
                <div style={{ marginTop: 'auto', paddingTop: '3rem', display: 'flex', justifyContent: 'flex-end', pageBreakInside: 'avoid', gap: '3rem', paddingBottom: '2rem' }}>
                    <div style={{ flex: 1, maxWidth: '240px', textAlign: 'center' }}>
                        ...
                        <p style={{ margin: 0, fontWeight: 900, fontSize: '0.75rem', color: '#1e293b' }}>RESPONSABLE IMPLEMENTACIÓN</p>
                    ...
                    <div style={{ flex: 1, maxWidth: '240px', textAlign: 'center' }}>
                        ...
                        <p style={{ margin: 0, fontWeight: 900, fontSize: '0.75rem', color: '#1e293b' }}>VERIFICADOR (SUPERVISOR)</p>
                    ...
                    <div style={{ flex: 1, maxWidth: '240px', textAlign: 'center' }}>
                        ...
                        <p style={{ margin: 0, fontWeight: 900, fontSize: '0.75rem', color: '#1e293b' }}>AUTORIDAD DE EHS</p>
