...
export default function Breadcrumbs(): React.ReactElement | null {
  ...
  const routeMap: RouteMap = {
    ...
    '/extinguishers': 'Control de Matafuegos',
    '/extintores': 'Control de Matafuegos',
    ...
    '/drills': 'Historial Simulacros',
    '/drills/new': 'Nuevo Simulacro',
    '/stop-cards': 'Historial STOP',
    '/stop-cards/new': 'Nueva Tarjeta STOP',
