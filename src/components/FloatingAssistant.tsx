...
import { 
  ...
  Volume2, Search, Settings, HelpCircle
} from 'lucide-react';
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                                    ...
                                    <span style={{ fontSize: '0.7rem', color: 'var(--color-text-muted)', fontWeight: 600 }}>En línea</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '0.6rem' }}>
                                ...
                                <button 
                                    ...
                                    style={{ 
                                        ...
                                        padding: '1rem', background: 'var(--gradient-premium)',
                                ...
                                >
                                    ...
                                    <span style={{ fontWeight: 800, fontSize: '0.85rem' }}>
                                        {isListening ? 'Escuchando Obra...' : 'Dictado de Campo'}
                                    </span>
